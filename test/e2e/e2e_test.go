...
const namespace = "gcp-kafka-auth-operator-system"

// testNameSpace where the examole custom resource is deployed
const testNameSpace = "test-kafka-user"

// serviceAccountName created for the project
const serviceAccountName = "gcp-kafka-auth-operator-controller-manager"

// metricsServiceName is the name of the metrics service of the project
const metricsServiceName = "gcp-kafka-auth-operator-controller-manager-metrics-service"

// metricsRoleBindingName is the name of the RBAC that will be created to allow get the metrics data
const metricsRoleBindingName = "gcp-kafka-auth-operator-metrics-binding"

var _ = Describe("Manager", Ordered, func() {

	SetDefaultEventuallyTimeout(2 * time.Minute)
	SetDefaultEventuallyPollingInterval(time.Second)
	testEnv := os.Getenv("TEST_ENV") // Expected values: "kind", "gcp"
		...
		Context("Manager", func() {
			...
			It("should ensure the metrics endpoint is serving metrics", func() {
				...
				cmd := exec.Command("kubectl", "create", "clusterrolebinding", metricsRoleBindingName,
					"--clusterrole=gcp-kafka-auth-operator-metrics-reader",
