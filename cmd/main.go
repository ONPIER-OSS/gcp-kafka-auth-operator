...
func init() {
	...
	utilruntime.Must(gcpkafkav1alpha1.AddToScheme(scheme))
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "2ce66565.k8s.onpier.de",
		Client: client.Options{
			Cache: &client.CacheOptions{
				DisableFor: []client.Object{
					&gcpkafkav1alpha1.KafkaUser{},
					&gcpkafkav1alpha1.ExternalKafkaUser{},
					&gcpkafkav1alpha1.ClusterTopic{},
				},
			},
		},
	...
	if err = (&controller.ClusterTopicReconciler{
		Client:         mgr.GetClient(),
		Scheme:         mgr.GetScheme(),
		KafkaInstance:  kafkaInstance,
		AdminUserEmail: adminUserEmail,
